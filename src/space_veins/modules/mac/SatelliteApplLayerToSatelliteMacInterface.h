...
/**
 * @brief
 * Interface between SatelliteApplLayer and SatelliteMac
 *
 ...
 * @ingroup macLayer
 */
class SPACE_VEINS_API SatelliteApplLayerToSatelliteMacInterface {
public:
    ...
    virtual ~SatelliteApplLayerToSatelliteMacInterface(){};
