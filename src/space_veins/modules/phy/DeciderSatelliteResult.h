...
/*
 * DeciderSatelliteResult.h
 *
 *  Created on: 04.02.2009
 *      Author: karl
 *
 *  Modified by Michele Segata (segata@ccs-labs.org)
 *  Modified by Mario Franke (research@m-franke.net)
 */
 ...
 * @ingroup ieee80211
 */
class SPACE_VEINS_API DeciderSatelliteResult: public veins::DeciderResult {
protected:
...
public:
     ...
     */
    DeciderSatelliteResult(bool isCorrect, double bitrate, double snr, double recvPower_dBm = 0, bool collision = false)
